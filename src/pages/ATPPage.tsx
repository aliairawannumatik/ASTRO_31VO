...
const atpElements = [
  {
    ...
    tp: [
      "Peserta didik dapat membaca, menulis dan membandingkan bilangan bulat. (kelas 7)",
      "Peserta didik dapat membaca, menulis dan membandingkan bilangan rasional dan irasional. (kelas 7)",
      "Peserta didik dapat membaca, menulis dan membandingkan bilangan desimal. (kelas 7)",
      "Peserta didik dapat membaca, menulis dan membandingkan bilangan berpangkat bulat. (kelas 7)",
      "Peserta didik dapat membaca, menulis dan membandingkan akar. (kelas 9)",
      "Peserta didik dapat membaca, menulis dan membandingkan bilangan dalam notasi ilmiah. (kelas 9)",
      "Peserta didik dapat menerapkan operasi aritmatika pada bilangan real. (kelas 7)",
      "Peserta didik dapat memberikan estimasi atau perkiraan dalam menyelesaikan masalah termasuk berkaitan dengan literasi finansial. (kelas 7)",
      "Peserta didik dapat menggunakan faktorisasi prima. (kelas 7)",
      "Peserta didik dapat menggunakan rasio skala, proporsi dan laju perubahan dalam penyelesaian masalah. (kelas 7)",
    ],
  },
  {
    no: "2",
    ...
    tp: [
      "Peserta didik dapat mengenali pola dalam bentuk susunan benda dan bilangan. (kelas 8)",
      "Peserta didik dapat memprediksi pola dalam bentuk susunan benda dan bilangan. (kelas 8)",
      "Peserta didik dapat menggeneralisasi pola dalam bentuk susunan benda dan bilangan. (kelas 8)",
      "Peserta didik dapat menyatakan suatu situasi ke dalam bentuk aljabar. (kelas 7)",
      "Peserta didik dapat menggunakan sifat-sifat operasi komutatif, asosiatif, dan distributif untuk menghasilkan bentuk aljabar yang ekuivalen. (kelas 7)",
      "Peserta didik dapat memahami relasi dan fungsi domain, kodomain, range. (kelas 8)",
      "Peserta didik dapat menyajikan relasi dan fungsi dalam bentuk diagram panah, tabel, himpunan pasangan berurutan. (kelas 8)",
      "Peserta didik dapat menyajikan relasi dan fungsi dalam bentuk grafik. (kelas 8)",
      "Peserta didik dapat membedakan beberapa fungsi nonlinear dari fungsi linear secara grafik. (kelas 8)",
      "Peserta didik dapat menyajikan persamaan linear. (kelas 7)",
      "Peserta didik dapat menyelesaikan persamaan dan pertidaksamaan linear satu variabel. (kelas 7)",
      "Peserta didik dapat menganalisis relasi, fungsi dan persamaan linear. (kelas 8)",
      "Peserta didik dapat menyelesaikan masalah dengan menggunakan relasi, fungsi, dan persamaan linear. (kelas 8)",
      "Peserta didik dapat menyelesaikan sistem persamaan linear dua variabel melalui beberapa cara untuk penyelesaian masalah. (kelas 8)",
    ],
  },
  {
    no: "3",
    ...
    tp: [
      "Peserta didik dapat menjelaskan cara untuk menentukan luas lingkaran. (kelas 8)",
      "Peserta didik dapat menyelesaikan masalah yang berkaitan dengan luas lingkaran. (kelas 8)",
      "Peserta didik dapat menjelaskan cara untuk menentukan luas permukaan bangun ruang sisi datar prisma dan limas. (kelas 8)",
      "Peserta didik dapat menjelaskan cara untuk menentukan luas permukaan bangun ruang sisi lengkung tabung, bola dan kerucut. (kelas 9)",
      "Peserta didik dapat menjelaskan cara untuk menentukan volume bangun ruang sisi datar prisma dan limas. (kelas 8)",
      "Peserta didik dapat menjelaskan cara untuk menentukan volume bangun ruang sisi lengkung tabung, bola dan kerucut. (kelas 9)",
      "Peserta didik dapat menyelesaikan masalah yang berkaitan dengan bangun ruang sisi datar prisma dan limas. (kelas 8)",
      "Peserta didik dapat menyelesaikan masalah yang berkaitan dengan bangun ruang sisi lengkung tabung, bola dan kerucut. (kelas 9)",
      "Peserta didik dapat menjelaskan pengaruh perubahan secara proporsional dari bangun datar dan bangun ruang terhadap ukuran panjang. (kelas 8)",
      "Peserta didik dapat menjelaskan pengaruh perubahan secara proporsional dari bangun datar dan bangun ruang terhadap besar sudut. (kelas 8)",
      "Peserta didik dapat menjelaskan pengaruh perubahan secara proporsional dari bangun datar dan bangun ruang terhadap luas. (kelas 8)",
      "Peserta didik dapat menjelaskan pengaruh perubahan secara proporsional dari bangun datar dan bangun ruang terhadap volume. (kelas 9)",
    ],
  },
  {
    no: "4",
    ...
    tp: [
      "Peserta didik dapat membuat jaring-jaring bangun ruang sisi datar kubus, balok, prisma dan limas. (kelas 8)",
      "Peserta didik dapat membuat jaring-jaring bangun ruang sisi lengkung tabung, kerucut dan bola. (kelas 9)",
      "Peserta didik dapat membuat bangun ruang sisi datar dari jaring-jaringnya. (kelas 8)",
      "Peserta didik dapat membuat bangun ruang sisi lengkung dari jaring-jaringnya. (kelas 9)",
      "Peserta didik dapat menggunakan hubungan antar-sudut yang terbentuk oleh dua garis yang berpotongan untuk menyelesaikan masalah. (kelas 7)",
      "Peserta didik dapat menggunakan hubungan antar-sudut yang terbentuk oleh dua garis sejajar yang dipotong sebuah garis transversal untuk menyelesaikan masalah. (kelas 7)",
      "Peserta didik dapat menentukan jumlah besar sudut dalam sebuah segitiga. (kelas 7)",
      "Peserta didik dapat menentukan besar sudut yang belum diketahui pada sebuah segitiga. (kelas 7)",
      "Peserta didik dapat menjelaskan sifat-sifat kekongruenan pada segitiga. (kelas 9)",
      "Peserta didik dapat menjelaskan sifat-sifat kekongruenan pada segiempat. (kelas 9)",
      "Peserta didik dapat menjelaskan sifat-sifat kesebangunan pada segitiga. (kelas 9)",
      "Peserta didik dapat menjelaskan sifat-sifat kesebangunan pada segiempat. (kelas 9)",
      "Peserta didik dapat menggunakan sifat-sifat kekongruenan dan kesebangunan untuk menyelesaikan masalah. (kelas 9)",
      "Peserta didik dapat menunjukkan kebenaran teorema Pythagoras. (kelas 8)",
      "Peserta didik dapat menggunakan teorema Pythagoras dalam menyelesaikan masalah termasuk jarak antara dua titik pada bidang koordinat Kartesius. (kelas 8)",
      "Peserta didik dapat melakukan transformasi tunggal refleksi titik, garis, dan bangun datar pada bidang koordinat Kartesius. (kelas 9)",
      "Peserta didik dapat melakukan transformasi tunggal translasi titik, garis, dan bangun datar pada bidang koordinat Kartesius. (kelas 9)",
      "Peserta didik dapat melakukan transformasi tunggal rotasi titik, garis, dan bangun datar pada bidang koordinat Kartesius. (kelas 9)",
      "Peserta didik dapat melakukan transformasi tunggal dilatasi titik, garis, dan bangun datar pada bidang koordinat Kartesius. (kelas 9)",
    ],
  },
  {
    no: "5",
    ...
    tp: [
      "Peserta didik dapat merumuskan pertanyaan penelitian yang relevan berdasarkan topik yang dipilih. (kelas 8)",
      "Peserta didik dapat mengumpulkan dan menyajikan data dengan cara yang sistematis dan terstruktur. (kelas 8)",
      "Peserta didik dapat menyajikan data. (kelas 8)",
      "Peserta didik dapat menganalisis data. (kelas 8)",
      "Peserta didik dapat menggunakan diagram batang dan diagram lingkaran untuk menyajikan dan menginterpretasi data. (kelas 8)",
      "Peserta didik dapat mengambil sampel yang mewakili suatu populasi untuk mendapatkan data yang terkait dengan diri dan lingkungan. (kelas 9)",
      "Peserta didik dapat menentukan dan menafsirkan rerata mean dari data tersebut untuk menyelesaikan masalah. (kelas 9)",
      "Peserta didik dapat menafsirkan median dari data tersebut untuk menyelesaikan masalah. (kelas 9)",
      "Peserta didik dapat menafsirkan modus dari data tersebut untuk menyelesaikan masalah. (kelas 9)",
      "Peserta didik dapat menafsirkan jangkauan range dari data tersebut untuk menyelesaikan masalah. (kelas 9)",
      "Peserta didik dapat membandingkan suatu data terhadap kelompoknya. (kelas 9)",
      "Peserta didik dapat membandingkan dua kelompok data. (kelas 9)",
      "Peserta didik dapat memprediksi dan membuat keputusan dari suatu data. (kelas 9)",
      "Peserta didik dapat menyelidiki kemungkinan adanya perubahan pengukuran pusat tersebut akibat perubahan data. (kelas 9)",
      "Peserta didik dapat menjelaskan dan menggunakan pengertian peluang untuk menentukan frekuensi harapan satu kejadian pada suatu percobaan sederhana. (kelas 9)",
      "Peserta didik dapat menjelaskan dan menggunakan pengertian frekuensi relatif untuk menentukan frekuensi harapan satu kejadian pada suatu percobaan sederhana. (kelas 9)",
    ],
  },
];
