...
const questions: MCQ[] = [
  ...
  },
  {
    ...
    options: ["26/52", "30/52", "32/52", "38/52"],
    answer: 2,
  },
  {
  ...
  },
  {
    ...
    content: "Sebuah koin dan sebuah dadu dilempar bersamaan. P(koin Angka) = 1/2 dan P(dadu > 4) = 2/6 = 1/3. Peluang mendapat koin Angka DAN dadu > 4 adalah ...",
  ...
  },
  {
    ...
    diagram: (
      <FreqTable
        caption="Perpotongan kejadian As dan Hitam"
        headers={["", "As", "Bukan As", "Total"]}
        rows={[["Hitam", 2, 24, 26], ["Merah", 2, 24, 26], ["Total", 4, 48, 52]]}
      />
    ),
    options: ["26/52", "28/52", "30/52", "32/52"],
    answer: 1,
  },
  {
    ...
    options: ["6/10 × 5/9 = 30/90", "6/10 × 6/10 = 36/100", "4/10 × 3/9 = 12/90", "6/10 × 4/9 = 24/90"],
    answer: 0,
  },
  {
    n: 10, title: "Soal ANBK – Kartu Merah atau Angka 7",
    content: "Dari 52 kartu bridge, satu kartu diambil. P(merah) = 26/52, P(angka 7) = 4/52, P(merah ∩ angka 7) = 2/52. Nilai P(merah ∪ angka 7) adalah ...",
    options: ["28/52 = 7/13", "30/52 = 15/26", "26/52 = 1/2", "32/52 = 8/13"],
    answer: 0,
  },
  {
    ...
    options: ["3/10 × 7/10 = 21/100", "2 × (3/10 × 7/10) = 42/100", "3/10 × 7/9 = 21/90", "6/10 × 4/9 = 24/90"],
    answer: 1,
  },
  {
  ...
  },
  {
    ...
    options: ["3/8 × 3/8 = 9/64", "3/8 × 2/8 = 6/64", "3/8 + 2/8 = 5/8", "2/8 × 3/8 = 6/64"],
    answer: 1,
  },
  {
    ...
    options: ["5/50 = 1/10", "10/50 = 1/5", "15/50 = 3/10", "45/50 = 9/10"],
    answer: 0,
  },
  {
    ...
    options: ["3/6 × 2/5 × 1/4 = 1/20", "3/6 × 3/5 × 3/4 = 27/120", "1/6 × 1/5 × 1/4 = 1/120", "3/6 × 2/6 × 1/6 = 6/216"],
    answer: 0,
  },
  {
    ...
    options: [
      "Ya, karena P(A ∩ B) = 1/26 = P(A) × P(B) = 1/26 ✓",
      "Tidak, karena P(A ∩ B) = 2/52 ≠ P(A) × P(B)",
      "Ya, karena A dan B tidak punya irisan",
      "Tidak, karena kartu As selalu berwarna hitam",
    ],
    answer: 0,
  },
  {
  ...
  },
  {
    ...
    options: ["50/100 = 1/2", "70/200 = 7/20", "70/100 = 7/10", "120/200 = 3/5"],
    answer: 2,
  },
];
