...
const questions: Q[] = [
  ...
  Qn(3, "Sifat Distribusi & Eksponen Aljabar", {
    ...
    parts: [
      ...
      { label: "d.", math: "(2x^3)^4 = 2^4 \\times x^{12} = \\ldots" },
      { label: "e.", math: "(3a^2 b)^3 = \\ldots" },
      { label: "f.", math: "\\left(\\frac{2x^2}{y^3}\\right)^3 = \\ldots" },
      { label: "g.", math: "\\frac{(2a)^4}{4a^2} = \\ldots" },
      { label: "h.", math: "\\frac{(ab)^5}{a^3 b^2} = \\ldots" },
    ],
  }),
  Qn(4, "Penyederhanaan Eksponen – Dasar & Tingkat Lanjut", {
    ...
    parts: [
      ...
      { label: "b.", math: "\\frac{a^5 b^3}{a^2 b} = \\ldots" },
      ...
      { label: "l.", math: "\\frac{(3a^2)^3 \\times a^4}{9a^8} = \\ldots" },
      { label: "m.", math: "\\left(\\frac{2x^3 y}{4xy^2}\\right)^2 = \\ldots" },
    ],
  }),
];
