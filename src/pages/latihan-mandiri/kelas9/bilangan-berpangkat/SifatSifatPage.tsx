...
const questions: Q[] = [
  ...
  Qn(10, "Penyederhanaan & Gabungan Sifat Tingkat Lanjut", {
    ...
    parts: [
      ...
      { label: "b.", math: "\\frac{(a^3)^4}{a^5 \\times a^3} = a^\\square" },
      { label: "c.", math: "\\frac{(x^3 y)^4}{x^8 y^3} = \\ldots" },
      { label: "d.", math: "\\frac{(2m^2)^3 \\times m^4}{4m^5} = \\ldots" },
      { label: "e.", math: "(m^4)^2 \\cdot m^3 \\div m^5 = \\ldots" },
      { label: "f.", math: "\\frac{(p^2 q^3)^4}{p^5 q^8} = \\ldots" },
      { label: "g.", math: "\\frac{(2^3 \\cdot 3^2)^2}{6^4} = \\ldots" },
      { label: "h.", math: "\\frac{(ab)^5}{a^3 b^4} \\cdot \\frac{a^2}{b} = \\ldots" },
      { label: "i.", math: "\\left(\\frac{x^3}{y^2}\\right)^4 \\cdot \\frac{y^{10}}{x^8} = \\ldots" },
      { label: "j.", math: "\\frac{(2^3)^4 \\times 2^2}{2^{10} \\times 2^2} = \\ldots" },
      { label: "k.", math: "\\frac{(3a^2)^3 \\times a^4}{9a^8} = \\ldots" },
      { label: "l.", math: "\\left(\\frac{2x^3 y}{4xy^2}\\right)^2 = \\ldots" },
    ],
  }),
