...
const questions: Q[] = [
  ...
  Qn(2, "Mengubah ke Notasi Ilmiah & Memperbaiki Notasi – UN/ANBK/TKA", {
    ...
    parts: [
      ...
      { label: "d.", math: "0{,}000072 = \\ldots" },
      { label: "e.", math: "0{,}0000004523 = \\ldots" },
      { label: "f.", math: "25 \\times 10^4 = \\ldots" },
      { label: "g.", math: "0{,}35 \\times 10^7 = \\ldots" },
      { label: "h.", math: "120 \\times 10^{-3} = \\ldots" },
    ],
  }),
