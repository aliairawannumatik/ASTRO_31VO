...
const questions: Q[] = [
  Qn(1, "Pangkat Nol – Konsep Dasar & Berbagai Ekspresi", {
    ...
    parts: [
      ...
      { label: "f.", text: "Seorang pedagang memiliki stok sebesar (x² + y²)⁰ ton, di mana x dan y adalah bilangan real tak nol. Berapa stok barangnya? Jelaskan mengapa!" },
      { label: "g.", text: "Dalam rumus fisika, koefisien gesek dinyatakan 3a⁰. Jika a = 7, berapakah nilai koefisien tersebut?" },
      { label: "h.", text: "Sebuah formula kimia menggunakan ekspresi (5x)⁰ mol. Berapa banyak mol yang dibutuhkan, berapapun nilai x-nya? Jelaskan konsepnya!" },
    ],
  }),
  Qn(2, "Pangkat Negatif – Definisi, Konversi & Nilai", {
    ...
    parts: [
      ...
      { label: "f.", text: "Dosis suatu obat dinyatakan 5⁻³ mg. Nyatakan dosis tersebut sebagai pecahan desimal!" },
      { label: "g.", text: "Jarak antar dua partikel sub-atom adalah (1/5)⁻³ nanometer. Hitung jarak tersebut dalam bilangan bulat!" },
      { label: "h.", text: "Dalam model keuangan, suatu nilai dinyatakan sebagai (−1/2)⁻². Hitung nilainya!" },
    ],
  }),
  Qn(3, "Pangkat Pecahan – Akar Kuadrat, Kubik & Umum", {
    ...
    parts: [
      ...
      { label: "h.", text: "Seorang arsitek menghitung panjang sisi bangunan berbentuk persegi dengan luas 25 m². Gunakan konsep pangkat pecahan untuk menemukan panjang sisinya!" },
      { label: "i.", text: "Volume sebuah tangki kubus adalah 8 m³. Dengan menggunakan pangkat pecahan, tentukan panjang sisi tangki!" },
      { label: "j.", text: "Luas kebun berbentuk persegi = 64 cm². Dengan konsep pangkat pecahan (Luas^(1/2)), berapa panjang sisi kebun?" },
    ],
  }),
  Qn(4, "Pangkat Pecahan Negatif – Dasar, Lanjutan & Ekspresi Kompleks", {
    ...
    parts: [
      ...
      { label: "g.", text: "Massa sebuah partikel dalam fisika kuantum dinyatakan 4^(−1/2) kg. Berapa massanya dalam kg?" },
      { label: "h.", text: "Konsentrasi larutan kimia = (8/27)^(−2/3) mol/L. Hitung konsentrasinya!" },
      { label: "i.", text: "Kecepatan partikel = 32^(−3/5) m/s. Nyatakan sebagai pecahan sederhana!" },
    ],
  }),
  Qn(5, "Pangkat Desimal", {
    ...
    parts: [
      ...
      { label: "d.", text: "Tingkat kelembapan udara dalam meteorologi dinyatakan 64^(0,75). Hitung nilainya dengan mengubah ke pangkat pecahan terlebih dahulu!" },
      { label: "e.", text: "Kecepatan angin rata-rata dinyatakan 8^(0,333...) knot. Ubah pangkat desimal ke pecahan dan hitung nilainya!" },
      { label: "f.", text: "Energi gelombang dimodelkan sebagai 27^(0,667) joule. Ubah ke pangkat pecahan terdekat dan hitung nilainya!" },
    ],
  }),
  Qn(6, "Gabungan Semua Jenis Pangkat", {
    ...
    parts: [
      ...
      { label: "d.", text: "Seorang ilmuwan menghitung energi dengan rumus: 2⁻² × 4^(3/2) + 3⁰. Hitung hasilnya!" },
      { label: "e.", text: "Luas suatu daerah dalam peta = 27^(2/3) − 4⁻¹ + 2⁰ satuan persegi. Hitung nilainya!" },
      { label: "f.", text: "Dalam model pertumbuhan ekonomi, indeks pertumbuhan = (8^(2/3) × 2⁻¹) ÷ 4⁰. Hitung indeks tersebut!" },
    ],
  }),
];
