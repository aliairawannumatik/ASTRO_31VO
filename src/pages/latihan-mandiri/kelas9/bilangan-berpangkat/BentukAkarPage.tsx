...
const questions: Q[] = [
  ...
  Qn(5, "Perkalian & Distribusi Bentuk Akar – UN/ANBK", {
    ...
    parts: [
      ...
      { label: "c.", math: "(\\sqrt{7}+\\sqrt{3})(\\sqrt{7}-\\sqrt{3}) = \\ldots" },
      { label: "d.", math: "(\\sqrt{10}+\\sqrt{6})(\\sqrt{10}-\\sqrt{6}) = \\ldots" },
      { label: "e.", math: "(2+\\sqrt{3})(2-\\sqrt{3}) = \\ldots" },
  ...
  Qn(6, "Merasionalkan Penyebut & Operasi Campuran – UN/ANBK/TKA", {
    ...
    parts: [
      ...
      { label: "b.", math: "\\frac{4}{\\sqrt{2}} = \\ldots" },
      { label: "c.", math: "\\frac{\\sqrt{3}}{\\sqrt{5}} = \\ldots" },
      { label: "d.", math: "\\frac{2\\sqrt{2}}{\\sqrt{6}} = \\ldots" },
      { label: "e.", math: "\\frac{3\\sqrt{5}}{\\sqrt{15}} = \\ldots" },
      { label: "f.", math: "\\frac{\\sqrt{18}+\\sqrt{8}}{\\sqrt{2}} = \\ldots" },
      { label: "g.", math: "\\frac{\\sqrt{27}-\\sqrt{12}}{\\sqrt{3}} = \\ldots" },
      { label: "h.", math: "\\frac{\\sqrt{6}}{\\sqrt{10}} = \\ldots" },
      { label: "i.", math: "\\frac{\\sqrt{3}+\\sqrt{6}}{\\sqrt{3}} = \\ldots" },
      { label: "j.", math: "\\frac{2\\sqrt{5}+\\sqrt{10}}{\\sqrt{5}} = \\ldots" },
    ],
  }),
  ...
  Qn(8, "Operasi Campuran Bilangan Akar – UN/ANBK/TKA", {
    ...
    parts: [
      ...
      { label: "b.", math: "\\sqrt{5} \\times \\sqrt{5} - \\sqrt{3} \\times \\sqrt{3} = \\ldots" },
      { label: "c.", math: "2\\sqrt{5} + 3\\sqrt{5} - \\sqrt{5} = \\ldots" },
      { label: "d.", math: "\\sqrt{12} \\times \\sqrt{3} + \\sqrt{2} \\times \\sqrt{50} = \\ldots" },
      { label: "e.", math: "\\sqrt{50} \\div \\sqrt{2} + \\sqrt{75} \\div \\sqrt{3} = \\ldots" },
      { label: "f.", math: "\\sqrt{48} \\div \\sqrt{3} + \\sqrt{2} \\times \\sqrt{8} = \\ldots" },
      { label: "g.", math: "3\\sqrt{2} + \\sqrt{2} \\times \\sqrt{8} - \\sqrt{18} = \\ldots" },
      { label: "h.", math: "\\sqrt{6} \\times \\sqrt{24} - \\sqrt{2} \\times \\sqrt{50} = \\ldots" },
      { label: "i.", math: "\\sqrt{100} \\div \\sqrt{4} + \\sqrt{3} \\times \\sqrt{27} = \\ldots" },
      { label: "j.", math: "2\\sqrt{3} \\times \\sqrt{12} - \\sqrt{5} \\times \\sqrt{20} + \\sqrt{2} \\times \\sqrt{8} = \\ldots" },
    ],
  }),
];
