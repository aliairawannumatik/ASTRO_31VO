...
const questions: Q[] = [
  ...
  Qn(2, "Menyederhanakan Bentuk Akar – UN/ANBK/TKA", {
    ...
    parts: [
      ...
      { label: "b.", math: "\\sqrt{18} = \\ldots" },
      { label: "c.", math: "\\sqrt{72} = \\ldots" },
      { label: "d.", math: "\\sqrt{98} = \\ldots" },
      { label: "e.", math: "\\sqrt{48} = \\ldots" },
      { label: "f.", math: "\\sqrt{75} = \\ldots" },
      { label: "g.", math: "\\sqrt{200} = \\ldots" },
      { label: "h.", math: "\\sqrt{1{,}44} = \\ldots" },
      { label: "i.", math: "\\sqrt{108} = \\ldots" },
      { label: "j.", math: "\\sqrt{147} = \\ldots" },
      { label: "k.", math: "\\sqrt{0{,}25} = \\ldots" },
    ],
  }),
