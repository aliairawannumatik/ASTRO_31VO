...
const questions: Q[] = [
  ...
  Qn(2, "Menyederhanakan Bentuk Akar – UN/ANBK/TKA", {
    ...
    parts: [
      ...
      { label: "k.", text: "Seorang tukang lantai memesan ubin persegi dengan luas 27 cm². Berapa panjang sisi ubin dalam bentuk akar paling sederhana?" },
  ...
  Qn(3, "Operasi Penjumlahan & Pengurangan Bentuk Akar – UN/ANBK/TKA", {
    ...
    parts: [
      ...
      { label: "k.", text: "Selisih tinggi dua pohon adalah (2√45 − 3√20 + 4√5) meter. Sederhanakan ekspresi tersebut!" },
    ],
  }),
