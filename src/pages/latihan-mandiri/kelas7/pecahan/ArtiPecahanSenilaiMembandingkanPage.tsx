...
const SoalSatu = () => (
  <div className="space-y-4">
    <p className="font-body text-sm text-white/90 leading-relaxed">
      Tentukan pecahan yang ditunjukkan oleh bagian yang diarsir pada gambar berikut!
    </p>
        ...
        <svg width="110" height="110" viewBox="0 0 120 120">
          ...
          {[0,1,2].map((i) => {
            ...
            return Array.from({ length: 5 }, (_, j) => {
              ...
              return (
                <line key={`${i}-${j}`}
                  x1={cx + t*(x1-cx)} y1={cy + t*(y1-cy)}
                  x2={cx + t*(x2-cx)} y2={cy + t*(y2-cy)}
...
const SoalDua = () => (
  <div className="space-y-3">
    <p className="font-body text-sm text-white/90 leading-relaxed">
      Gambarlah bangun datar dan arsir bagian yang ditunjukkan!
    </p>
    <div className="space-y-2 pl-1">
      {[
        { letter: "a", text: "Buatlah sebuah lingkaran, bagilah menjadi enam bagian sama besar, kemudian arsir dua bagian!" },
        { letter: "b", text: "Ulangi langkah pada poin a dengan menggunakan tiga bentuk bangun datar yang berbeda!" },
      ].map(({ letter, text }) => (
...
const SoalTiga = () => (
  <div className="space-y-4">
    <p className="font-body text-sm text-white/90 leading-relaxed">
      Isilah titik-titik berikut untuk menyatakan pecahan-pecahan yang sama nilainya!
    </p>
...
const SoalEmpat = () => (
  <div className="space-y-4">
    <p className="font-body text-sm text-white/90 leading-relaxed">
      Tulislah pecahan-pecahan berikut dalam bentuk yang paling sederhana!
    </p>
...
const SoalLima = () => (
  <div className="space-y-4">
    <p className="font-body text-sm text-white/90 leading-relaxed">
      Gunakan lambang <InlineMath math=">" /> atau <InlineMath math="<" /> untuk menyatakan hubungan setiap pasangan pecahan berikut!
    </p>
...
const SoalEnam = () => (
  <div className="space-y-4">
    <p className="font-body text-sm text-white/90 leading-relaxed">
      Susunlah deretan pecahan berikut dalam urutan naik (dari terkecil ke terbesar)!
    </p>
    <div className="space-y-3 pl-1">
      {[
        ...
        <div key={l} className="flex items-center gap-2 flex-wrap bg-indigo-500/5 border border-indigo-500/15 rounded-lg px-4 py-2.5">
          ...
          <span className="ml-auto text-indigo-400/30 text-xs font-body">urutan naik →</span>
        </div>
      ))}
    </div>
  </div>
...
const SoalTujuh = () => (
  <div className="space-y-3">
    <p className="font-body text-sm text-white/90 leading-relaxed">
      Nyatakan bagian berikut sebagai pecahan!
    </p>
    <div className="space-y-2 pl-1">
      {[
        { letter: "a", text: "Banyaknya hari sekolah dalam satu minggu (Senin–Jumat) sebagai bagian dari banyaknya hari dalam satu minggu penuh." },
        { letter: "b", text: "Banyak siswa perempuan di kelasmu sebagai bagian dari seluruh siswa yang ada di kelasmu." },
      ].map(({ letter, text }) => (
        <div key={letter} className="flex items-start gap-2.5">
...
const SoalDelapan = () => (
  <div className="space-y-3">
    <p className="font-body text-sm text-white/90 leading-relaxed">
      Carilah informasi melalui internet, lalu nyatakan hasilnya dalam bentuk pecahan!
    </p>
    <div className="space-y-2 pl-1">
      {[
        { letter: "a", text: "Banyak penduduk usia sekolah (7–15 tahun) di Indonesia terhadap total seluruh penduduk Indonesia." },
        { letter: "b", text: "Panjang garis pantai Pulau Jawa terhadap total panjang garis pantai seluruh Indonesia." },
        { letter: "c", text: "Luas daratan Pulau Kalimantan terhadap total luas daratan seluruh wilayah Indonesia." },
      ].map(({ letter, text }) => (
        <div key={letter} className="flex items-start gap-2.5">
...
const cards = [
  {
    num: 1, tag: "Gambar", tagColor: "bg-violet-500/20 text-violet-300 border-violet-400/40",
  ...
  {
    num: 2, tag: "Kreativitas", tagColor: "bg-orange-500/20 text-orange-300 border-orange-400/40",
  ...
  {
    num: 3, tag: "Pecahan Senilai", tagColor: "bg-cyan-500/20 text-cyan-300 border-cyan-400/40",
  ...
  {
    num: 4, tag: "Penyederhanaan", tagColor: "bg-emerald-500/20 text-emerald-300 border-emerald-400/40",
  ...
  {
    num: 5, tag: "Membandingkan", tagColor: "bg-rose-500/20 text-rose-300 border-rose-400/40",
  ...
  {
    num: 6, tag: "Mengurutkan", tagColor: "bg-indigo-500/20 text-indigo-300 border-indigo-400/40",
  ...
  {
    num: 7, tag: "Kontekstual", tagColor: "bg-amber-500/20 text-amber-300 border-amber-400/40",
  ...
  {
    num: 8, tag: "Riset", tagColor: "bg-teal-500/20 text-teal-300 border-teal-400/40",
