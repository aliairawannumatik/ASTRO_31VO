...
const subtopics = [
  { label: "PENJUMLAHAN BILANGAN BULAT", path: "/latihan-mandiri/kelas-7/bilangan-bulat/penjumlahan", soal: 8, icon: Plus, gradient: "from-blue-900/40 to-indigo-900/30", border: "border-blue-500/30", badge: "bg-blue-500/20 text-blue-300 border-blue-400/40", iconBg: "bg-blue-500/20", iconColor: "text-blue-400", leftBar: "from-blue-400 to-indigo-500", desc: "Menjumlahkan bilangan bulat positif & negatif, sifat komutatif & asosiatif" },
      ...
      <div className="relative z-10 max-w-3xl w-full px-4 py-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <div className="flex items-center gap-3 bg-white/5 border border-white/10 rounded-xl px-5 py-2 mt-2">
            ...
            <span className="text-white/70 text-xs font-body">48 {t('practice.suffixSoalTotal')} · UN / TKA / ANBK</span>
            <span className="text-yellow-400 text-sm">⭐</span>
          </div>
        </div>
