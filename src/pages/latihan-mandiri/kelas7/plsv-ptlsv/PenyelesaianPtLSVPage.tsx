...
const Soal1 = () => (
  <div className="space-y-3">
    <p className="font-body text-sm text-white/90 leading-relaxed">
      Tentukan himpunan penyelesaian dari setiap pertidaksamaan berikut dengan{" "}
      <span className="text-rose-300 font-semibold">variabel pada bilangan bulat</span>!
    </p>
...
const Soal2 = () => (
  <div className="space-y-3">
    <p className="font-body text-sm text-white/90 leading-relaxed">
      Tentukan himpunan penyelesaian dari setiap pertidaksamaan berikut dengan{" "}
      <span className="text-pink-300 font-semibold">variabel pada bilangan bulat</span>!
    </p>
...
const Soal3 = () => (
  <div className="space-y-3">
    <p className="font-body text-sm text-white/90 leading-relaxed">
      ...
      <span className="text-fuchsia-300 font-semibold">pertidaksamaan ganda</span>{" "}
      berikut dengan variabel pada bilangan bulat!
    </p>
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 pl-1">
      {[
        { n: "39", e: "3 < n + 5 < 10" },
...
const Soal4 = () => (
  <div className="space-y-3">
    <p className="font-body text-sm text-white/90 leading-relaxed">
      Tentukan himpunan penyelesaian dari setiap pertidaksamaan berikut dengan{" "}
      <span className="text-violet-300 font-semibold">variabel pada bilangan bulat</span>!
    </p>
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 pl-1">
      {[
...
const Soal5 = () => (
  <div className="space-y-4">
    <p className="font-body text-sm text-white/90 leading-relaxed">
      Untuk <span className="text-indigo-300 font-semibold">bilangan cacah <M math="C" /></span>,{" "}
      <span className="text-indigo-300 font-semibold">bilangan bulat <M math="B" /></span>, dan{" "}
      <span className="text-indigo-300 font-semibold">bilangan rasional <M math="Q" /></span>,{" "}
...
const cards = [
  {
    num: 1, tag: "Pertidaksamaan Sederhana", tagColor: "bg-rose-500/20 text-rose-300 border-rose-400/40",
  ...
  {
    num: 2, tag: "Pertidaksamaan Campuran & Distributif", tagColor: "bg-pink-500/20 text-pink-300 border-pink-400/40",
  ...
  {
    num: 3, tag: "Pertidaksamaan Ganda", tagColor: "bg-fuchsia-500/20 text-fuchsia-300 border-fuchsia-400/40",
  ...
  {
    num: 4, tag: "Pertidaksamaan Pecahan", tagColor: "bg-violet-500/20 text-violet-300 border-violet-400/40",
  ...
  {
    num: 5, tag: "Himpunan Penyelesaian (B / C / Q)", tagColor: "bg-indigo-500/20 text-indigo-300 border-indigo-400/40",
