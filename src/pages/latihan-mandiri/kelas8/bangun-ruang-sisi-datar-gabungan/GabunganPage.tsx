...
const questions: Q[] = [
  ...
  Qn(8, "Soal TKA – Souvenir Berbentuk Kubus + Limas", {
    ...
    diagram: <BalokLimasSVG p="4" l="4" tb="4" tl="3" />,
    parts: [
  ...
  Qn(22, "Soal UN – Mencari Dimensi dari Volume Gabungan", {
    ...
    diagram: <BalokLimasSVG p="8" l="8" tb="8" tl="t" />,
    parts: [
  ...
  Qn(23, "Soal TKA – Lapisan Cokelat pada Souvenir", {
    ...
    diagram: <BalokLimasSVG p="5" l="5" tb="5" tl="4" />,
    parts: [
  ...
  Qn(37, "Soal UN – Mencari Tinggi Gabungan dari Volume Total", {
    ...
    diagram: <BalokLimasSVG p="10" l="10" tb="t₁" tl="t₂" />,
    parts: [
