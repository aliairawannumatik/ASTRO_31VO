...
const latihanDasar: LatihanSoal[] = [
  { no: 1, soal: "Nilai ujian 8 siswa: 75, 80, 65, 90, 85, 70, 80, 75. Rata-rata nilai tersebut adalah …", options: ["A. 76,25", "B. 77,5", "C. 78,75", "D. 80"], jawaban: "B", pembahasan: "Jumlah = 75+80+65+90+85+70+80+75 = 620\nRata-rata = 620 ÷ 8 = 77,5 → Jawaban B" },
  ...
  { no: 11, soal: "Lima bilangan: 10, 12, 15, x, 18. Rata-ratanya 14. Nilai x adalah …", options: ["A. 11", "B. 13", "C. 15", "D. 17"], jawaban: "C", pembahasan: "Jumlah = 14 × 5 = 70\n10 + 12 + 15 + x + 18 = 70\n55 + x = 70, x = 15 → Jawaban C" },
