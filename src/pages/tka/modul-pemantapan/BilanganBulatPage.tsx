...
const latihanDasar: LatihanSoal[] = [
  ...
  { no: 10, soal: "Bilangan bulat antara $-\\sqrt{50}$ dan $\\sqrt{20}$ adalah …", options: ["A. 11 bilangan", "B. 12 bilangan", "C. 13 bilangan", "D. 14 bilangan"], jawaban: "B", pembahasan: "$-\\sqrt{50} \\approx -7,07$ dan $\\sqrt{20} \\approx 4,47$\nBilangan bulat di antaranya: -7, -6, -5, -4, -3, -2, -1, 0, 1, 2, 3, 4 = 12 bilangan → Jawaban B" },
