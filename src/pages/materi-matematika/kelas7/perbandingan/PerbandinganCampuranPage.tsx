...
const translations = {
  id: {
    ...
    c2Round: "Dibulatkan ke atas karena kebutuhan minimal pekerja.",
    c2Result: "Dibutuhkan 14 pekerja (dibulatkan ke atas).",
  ...
  en: {
    ...
    c2Id: "O₁ = 8, T₁ = 10, H₁ = 120, O₂ = x, T₂ = 15, H₂ = 300",
    c2Round: "Rounded up because a minimum number of workers is required.",
    c2Result: "14 workers are needed (rounded up).",
