...
/* ─────────────────────────────────────────────────────────────
   SELIMUT UNROLL ANIMATION — CSS scaleX unroll, no canvas/WebGL
───────────────────────────────────────────────────────────── */
type UnrollPhase = "idle" | "running" | "done";
...
const SelimutUnrollAnimation = () => {
  ...
  const handleAnimEnd = () => setPhase("done");
  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        .su-unroll-anim {
          animation: su-unroll 1.5s ease-out forwards;
          transform-origin: left center;
        }
        .su-label-anim {
          animation: su-label-in 0.4s ease-out 1.3s both;
        }
        .su-arrow-pulse {
          animation: su-arrow-pulse 1s ease-in-out infinite;
        }
      `}</style>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <div style={{ flex: "0 0 108px" }}>
          <svg viewBox="0 0 108 188" width="108" height="188" style={{ display: "block", overflow: "visible" }}>
            {/* selimut body — fades when open */}
            <path
              d="M 14,44 A 40,11 0 0,1 94,44 L 94,148 A 40,11 0 0,0 14,148 Z"
              fill="rgba(168,85,247,0.38)"
              stroke="#a855f7"
              strokeWidth="1.8"
              style={{
                opacity: isActive ? 0.18 : 1,
                transition: isActive ? "opacity 1.5s ease-out" : "none",
              }}
            />
            {/* dashed back arc of selimut top */}
            <path d="M 14,44 A 40,11 0 0,0 94,44"
              fill="none" stroke="rgba(168,85,247,0.3)" strokeWidth="1" strokeDasharray="4,2"/>

            {/* bottom cap */}
            <ellipse cx="54" cy="148" rx="40" ry="11"
              fill="rgba(99,102,241,0.45)" stroke="#818cf8" strokeWidth="1.5"/>
            {/* top cap */}
            <ellipse cx="54" cy="44" rx="40" ry="11"
              fill="rgba(99,102,241,0.55)" stroke="#818cf8" strokeWidth="1.5"/>

            {/* r dimension */}
            <line x1="54" y1="44" x2="94" y2="44" stroke="#f59e0b" strokeWidth="1.5" strokeDasharray="3,2"/>
            <circle cx="54" cy="44" r="2.5" fill="#f59e0b"/>
            <circle cx="94" cy="44" r="2.5" fill="#f59e0b"/>
            <text x="74" y="37" fill="#f59e0b" fontSize="10" fontFamily="monospace" fontWeight="bold" textAnchor="middle">r</text>

            {/* t dimension */}
            <line x1="98" y1="44"  x2="98" y2="148" stroke="#22c55e" strokeWidth="1.5"/>
            <line x1="94" y1="44"  x2="102" y2="44"  stroke="#22c55e" strokeWidth="1.2"/>
            <line x1="94" y1="148" x2="102" y2="148" stroke="#22c55e" strokeWidth="1.2"/>
            <text x="106" y="100" fill="#22c55e" fontSize="11" fontFamily="monospace" fontWeight="bold" textAnchor="middle">t</text>

            {/* selimut highlight label */}
            <text x="54" y="102" fill="#e9d5ff" fontSize="9" fontFamily="monospace" fontWeight="bold"
              textAnchor="middle"
              style={{ opacity: isActive ? 0.1 : 0.9, transition: "opacity 1s ease-out" }}>
              SELIMUT
            </text>

            <text x="54" y="175" fill="#7c3aed" fontSize="8.5" fontFamily="monospace" textAnchor="middle">Tabung 3D</text>
          </svg>
        </div>
        ...
        <div style={{ flex: "0 0 28px", textAlign: "center" }}>
          <div
            className={isActive && phase !== "done" ? "su-arrow-pulse" : ""}
            style={{
              fontSize: 20,
              color: "#a855f7",
          ...
          >→</div>
          <div style={{ fontSize: 7, color: "#7c3aed", fontFamily: "monospace", marginTop: 1, letterSpacing: "0.04em" }}>
            {isActive ? "buka!" : "buka"}
          </div>
        </div>

        {/* ── RIGHT: unrolled rectangle ── */}
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{
            ...
            marginBottom: 5,
            opacity: isOpen ? 1 : 0,
            transition: isOpen ? "opacity 0.4s ease 0.1s" : "none",
          }}>
            ←&nbsp;&nbsp;lebar = 2πr&nbsp;&nbsp;→
          </div>
          ...
          <div style={{ display: "flex", alignItems: "stretch", gap: 6 }}>
            ...
            {/* The unrolling rectangle */}
            <div style={{ flex: 1, position: "relative", minWidth: 0 }}>
              <div
                key={`su-rect-${animKey}`}
                className={phase === "running" ? "su-unroll-anim" : ""}
                style={{
                  height: 104,
                  background: "linear-gradient(135deg, rgba(168,85,247,0.32) 0%, rgba(124,58,237,0.20) 100%)",
                ...
                onAnimationEnd={phase === "running" ? handleAnimEnd : undefined}
              >
                {/* inner content — appears after animation */}
                <div style={{
                  textAlign: "center",
                  opacity: isOpen ? 1 : 0,
                  transition: isOpen ? "opacity 0.5s ease 0.15s" : "none",
                  padding: "0 8px",
                }}>
                  <div style={{ fontSize: 10, fontFamily: "monospace", fontWeight: "bold", color: "#e9d5ff", marginBottom: 4 }}>
                    SELIMUT TABUNG
                  </div>
                  <div style={{ fontSize: 9, fontFamily: "monospace", color: "#c4b5fd" }}>
                    Persegi Panjang
                  </div>
                </div>
              </div>

              {/* dimension lines on the rectangle — top */}
              {isOpen && (
                <div className="su-label-anim" style={{
                  position: "absolute",
                  top: -1,
                  left: 0,
                  right: 0,
            ...
            <div style={{
              ...
              alignItems: "center",
              gap: 2,
              opacity: isOpen ? 1 : 0.12,
              transition: "opacity 0.5s ease 0.1s",
            }}>
              <div style={{ flex: 1, width: 1.5, background: "#22c55e", minHeight: 8 }}/>
              <span style={{
                fontSize: 12,
                color: "#22c55e",
                fontFamily: "monospace",
          ...
          {/* formula below rectangle */}
          <div style={{
            marginTop: 8,
            textAlign: "center",
            opacity: isOpen ? 1 : 0,
            transition: isOpen ? "opacity 0.5s ease 0.3s" : "none",
          }}>
            <div style={{
      ...
      <div style={{ display: "flex", gap: 8, justifyContent: "center", marginTop: 14 }}>
        <button
          ...
          style={{
            ...
            background: phase === "idle" ? "rgba(168,85,247,0.18)" : "transparent",
            color: "#d8b4fe",
            fontSize: 12,
            fontWeight: "bold",
            cursor: phase !== "idle" ? "not-allowed" : "pointer",
            opacity: phase !== "idle" ? 0.38 : 1,
            fontFamily: "inherit",
