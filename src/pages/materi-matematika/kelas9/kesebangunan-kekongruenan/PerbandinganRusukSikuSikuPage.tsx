...
/* ── DIAGRAMS ──
   ...
   A = kiri atas, B = kiri bawah (AB vertikal), C = kanan atas (AC horizontal).
   BC = sisi miring (hipotenusa, diagonal). AD ⊥ BC, D pada BC.
   Koordinat: A=(55,38), B=(55,198), C=(175,38)
   ...
   D = B + 128*(0.6,-0.8) = (55+76.8, 198-102.4) = (131.8,95.6) ≈ (132,96)
──────────────────────────────────────────── */

/* Sudut siku-siku di A=(55,38): AB ke bawah (0,1), AC ke kanan (1,0) → kotak axis-aligned */
const RightAngleA = () => (
  <path d="M 55,47 L 64,47 L 64,38" fill="none" stroke="#f97316" strokeWidth="1.5"/>
);

/* Sudut siku-siku di D=(132,96): AD⊥BC
   DA_unit (D→A) = (55-132,38-96)/96 = (-76.8,-57.6)/96 = (-0.8,-0.6)
   BC_unit = (0.6,-0.8), s=8 */
const RightAngleD = () => {
  const s = 8;
  const p1 = { x: 132 + s*(-0.8), y: 96 + s*(-0.6) };   // toward A
  const p2 = { x: 132 + s*(0.6),  y: 96 + s*(-0.8) };   // along BC
...
const DiagramSikuSiku = () => (
  <svg viewBox="0 0 260 220" className="w-full max-w-sm mx-auto">
    {/* Sub-triangles shaded: △ABD (left/lower) and △ACD (upper/right) */}
    <polygon points="55,38 55,198 132,96" fill="#4ade80"  fillOpacity="0.18" stroke="none"/>
    <polygon points="55,38 175,38 132,96" fill="#a855f7" fillOpacity="0.18" stroke="none"/>
    {/* Main triangle ABC */}
    <polygon points="55,38 55,198 175,38" fill="none" stroke="#60a5fa" strokeWidth="2.2"/>
    {/* Altitude AD */}
    <line x1="55" y1="38" x2="132" y2="96" stroke="#facc15" strokeWidth="2" strokeDasharray="5,3"/>
    <RightAngleA />
    <RightAngleD />
    {/* Vertex labels */}
    <text x="36"  y="36"  fontSize="12" fill="#93c5fd" fontWeight="bold">A</text>
    <text x="36"  y="212" fontSize="12" fill="#93c5fd" fontWeight="bold">B</text>
    <text x="178" y="36"  fontSize="12" fill="#93c5fd" fontWeight="bold">C</text>
    <text x="136" y="109" fontSize="11" fill="#fde68a" fontWeight="bold">D</text>
    {/* Side labels */}
    <text x="38"  y="118" fontSize="10" fill="#4ade80" fontWeight="bold" textAnchor="middle">AB</text>
    <text x="115" y="32"  fontSize="10" fill="#c084fc" fontWeight="bold" textAnchor="middle">AC</text>
    <text x="82"  y="70"  fontSize="10" fill="#facc15" fontWeight="bold">AD</text>
    <text x="86"  y="152" fontSize="9"  fill="#86efac" textAnchor="middle">BD</text>
    <text x="155" y="72"  fontSize="9"  fill="#86efac" textAnchor="middle">DC</text>
    {/* Legend */}
    <rect x="3" y="200" width="254" height="18" rx="4" fill="#0f172a" stroke="#334155"/>
    <text x="130" y="212" textAnchor="middle" fontSize="8" fill="#fde68a" fontWeight="bold">△ABD ~ △CAD ~ △CAB (tiga segitiga saling sebangun)</text>
    <rect x="3" y="3" width="254" height="18" rx="4" fill="#0f172a" stroke="#334155"/>
    <text x="130" y="15"  textAnchor="middle" fontSize="8" fill="#94a3b8">△ABC siku-siku di A, AB tegak, AC mendatar, AD ⊥ BC</text>
  </svg>
);
...
const DiagramProyeksiAlas = () => (
  <svg viewBox="0 0 260 220" className="w-full max-w-sm mx-auto">
    <polygon points="55,38 55,198 132,96" fill="#4ade80" fillOpacity="0.18" stroke="none"/>
    <polygon points="55,38 55,198 175,38" fill="none" stroke="#60a5fa" strokeWidth="2"/>
    <line x1="55" y1="38" x2="132" y2="96" stroke="#facc15" strokeWidth="1.8" strokeDasharray="5,3"/>
    <RightAngleA />
    <RightAngleD />
    <text x="36"  y="36"  fontSize="12" fill="#93c5fd" fontWeight="bold">A</text>
    <text x="36"  y="212" fontSize="12" fill="#93c5fd" fontWeight="bold">B</text>
    ...
    <text x="136" y="109" fontSize="11" fill="#fde68a" fontWeight="bold">D</text>
    <text x="38"  y="118" fontSize="10" fill="#4ade80" fontWeight="bold" textAnchor="middle">AB</text>
    <text x="86"  y="152" fontSize="9"  fill="#4ade80" textAnchor="middle">BD</text>
    <text x="155" y="72"  fontSize="9"  fill="#94a3b8" textAnchor="middle">DC</text>
    <rect x="3" y="200" width="254" height="18" rx="4" fill="#0f172a" stroke="#4ade80" strokeWidth="1"/>
    <text x="130" y="209" textAnchor="middle" fontSize="8" fill="#fde68a" fontWeight="bold">Proyeksi Rusuk Tegak AB:</text>
    <text x="130" y="217" textAnchor="middle" fontSize="9" fill="#4ade80" fontWeight="bold">AB² = BD × BC</text>
  </svg>
);

const DiagramProyeksiTegak = () => (
  <svg viewBox="0 0 260 220" className="w-full max-w-sm mx-auto">
    <polygon points="55,38 175,38 132,96" fill="#c084fc" fillOpacity="0.18" stroke="none"/>
    <polygon points="55,38 55,198 175,38" fill="none" stroke="#c084fc" strokeWidth="2"/>
    <line x1="55" y1="38" x2="132" y2="96" stroke="#facc15" strokeWidth="1.8" strokeDasharray="5,3"/>
    <RightAngleA />
    <RightAngleD />
    <text x="36"  y="36"  fontSize="12" fill="#e9d5ff" fontWeight="bold">A</text>
    <text x="36"  y="212" fontSize="12" fill="#e9d5ff" fontWeight="bold">B</text>
    <text x="178" y="36"  fontSize="12" fill="#e9d5ff" fontWeight="bold">C</text>
    <text x="136" y="109" fontSize="11" fill="#fde68a" fontWeight="bold">D</text>
    <text x="115" y="32"  fontSize="10" fill="#c084fc" fontWeight="bold" textAnchor="middle">AC</text>
    <text x="86"  y="152" fontSize="9"  fill="#94a3b8" textAnchor="middle">BD</text>
    <text x="155" y="72"  fontSize="9"  fill="#c084fc" textAnchor="middle">DC</text>
    <rect x="3" y="200" width="254" height="18" rx="4" fill="#0f172a" stroke="#c084fc" strokeWidth="1"/>
    <text x="130" y="209" textAnchor="middle" fontSize="8" fill="#fde68a" fontWeight="bold">Proyeksi Rusuk Mendatar AC:</text>
    <text x="130" y="217" textAnchor="middle" fontSize="9" fill="#c084fc" fontWeight="bold">AC² = DC × BC</text>
  </svg>
);

const DiagramGarisTinggi = () => (
  <svg viewBox="0 0 260 220" className="w-full max-w-sm mx-auto">
    <polygon points="55,38 55,198 132,96" fill="#facc15" fillOpacity="0.10" stroke="none"/>
    <polygon points="55,38 175,38 132,96" fill="#facc15" fillOpacity="0.10" stroke="none"/>
    <polygon points="55,38 55,198 175,38" fill="none" stroke="#22c55e" strokeWidth="2"/>
    <line x1="55" y1="38" x2="132" y2="96" stroke="#facc15" strokeWidth="2" strokeDasharray="5,3"/>
    <RightAngleA />
    <RightAngleD />
    <text x="36"  y="36"  fontSize="12" fill="#86efac" fontWeight="bold">A</text>
    <text x="36"  y="212" fontSize="12" fill="#86efac" fontWeight="bold">B</text>
    <text x="178" y="36"  fontSize="12" fill="#86efac" fontWeight="bold">C</text>
    <text x="136" y="109" fontSize="11" fill="#fde68a" fontWeight="bold">D</text>
    <text x="82"  y="70"  fontSize="10" fill="#facc15" fontWeight="bold">AD</text>
    <text x="86"  y="152" fontSize="9"  fill="#facc15" textAnchor="middle">BD</text>
    <text x="155" y="72"  fontSize="9"  fill="#facc15" textAnchor="middle">DC</text>
    <rect x="3" y="200" width="254" height="18" rx="4" fill="#0f172a" stroke="#22c55e" strokeWidth="1"/>
    <text x="130" y="209" textAnchor="middle" fontSize="8" fill="#fde68a" fontWeight="bold">Garis Tinggi ke Sisi Miring:</text>
    <text x="130" y="217" textAnchor="middle" fontSize="9" fill="#22c55e" fontWeight="bold">AD² = BD × DC</text>
  </svg>
);
