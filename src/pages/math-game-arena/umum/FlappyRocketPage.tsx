  ...
  if (phase === "idle") {
    return (
      <MathGameIntro
        ...
        decorations={[
          { src: "/pesawat.png", className: "absolute top-[10%] left-[8%] w-14 h-16 md:w-20 md:h-24 opacity-70 animate-float-slow", glowRgba: "rgba(0,200,255,0.45)" },
          { src: "/pesawat.png", className: "absolute top-[35%] right-[6%] w-12 h-14 md:w-16 md:h-20 opacity-60 animate-float-medium", glowRgba: "rgba(0,200,255,0.4)" },
          { src: "/pesawat.png", className: "absolute bottom-[18%] left-[10%] w-16 h-20 md:w-24 md:h-28 opacity-75 animate-float-fast", glowRgba: "rgba(0,200,255,0.5)" },
        ]}
        instructions={[
