  ...
  useEffect(() => {
    ...
    const loop = (ts: number) => {
      ...
      if (phase === "idle" || phase === "dead") {
        ...
        ctx.strokeStyle = phase === "idle" ? "#00f0ff" : "#ff5e87"; ctx.lineWidth = 3; ctx.strokeRect(30, 185, CW - 60, 250);
        const oc = phase === "idle" ? "#00f0ff" : "#ff5e87";
        drawHUD(phase === "idle" ? "SHOOT TANK!" : "PERMAINAN SELESAI", CW / 2, 228, 20, oc, "center");
        drawHUD(phase === "idle" ? "Klik / sentuh untuk mulai" : `Skor: ${scoreRef.current}`, CW / 2, 273, 15, "#ffffff", "center");
        ...
        if (phase === "dead") drawHUD(`Terbaik: ${bestRef.current}`, CW / 2, 408, 13, "#c4b5fd", "center");
      }
