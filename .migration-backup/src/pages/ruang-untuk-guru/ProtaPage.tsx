...
import { ArrowLeft, CalendarRange, ChevronRight, Save, FileDown, FileText } from "lucide-react";
...
const ProtaPage = () => {
  ...
  const handlePrintWord = () => {
    playPopSound();
    const html = `<!DOCTYPE html><html lang="id"><head><meta charset="UTF-8"><title>PROTA - numatik</title><style>${dokumenStyle}</style></head><body>${buildDokumenBody()}</body></html>`;
