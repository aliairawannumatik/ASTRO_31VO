...
/* ─────────────────────────────────────────────────────────
   GAMBAR SOAL & OPSI (disalin dari OlimpiadeBangunRuangSisiDatarPage.tsx)
   ──────────────────────────────────────────────────────────────── */
...
const dasarOptionImages: Record<string, string> = {
...
/** Gambar soal, dibungkus supaya rapi & center */
const SoalImg = ({ src, no }: { src: string; no: number }) => (
  <img
    src={src}
    alt={`Gambar soal ${no}`}
    className="max-w-[280px] w-full rounded-lg border border-white/10 bg-white/5 p-2 mx-auto block"
  />
);

/** Gambar opsi jawaban (untuk soal no.1) */
const OptImg = ({ src, letter }: { src: string; letter: string }) => (
  <img
    src={src}
    alt={`Opsi ${letter}`}
...
const latihanDasar: LatihanSoal[] = [
  {
    no: 1,
    soal: "Pada rangkaian persegi berikut yang merupakan jaring-jaring kubus adalah ...",
    options: ["A", "B", "C", "D"],
    optionsJsx: [
      <OptImg key="1a" src={dasarOptionImages.A} letter="A" />,
      <OptImg key="1b" src={dasarOptionImages.B} letter="B" />,
      <OptImg key="1c" src={dasarOptionImages.C} letter="C" />,
      <OptImg key="1d" src={dasarOptionImages.D} letter="D" />,
    ],
  },
  { no: 2, soal: "Perhatikan gambar!\nAgar dapat membentuk balok, persegipanjang yang harus dihilangkan bernomor ....", gambar: <SoalImg src={dasarImages[2]} no={2} />, options: ["A. 5 dan 6", "B. 5 dan 7", "C. 1 dan 7", "D. 1 dan 8"] },
  { no: 3, soal: "Daerah yang diarsir pada gambar disebut ....", gambar: <SoalImg src={dasarImages[3]} no={3} />, options: ["A. Diagonal bidang", "B. Bidang diagonal", "C. Diagonal ruang", "D. Diagonal sisi"] },
  ...
  { no: 9, soal: "Perhatikan gambar berikut\nSebuah balok dibentuk dari kubus-kubus kecil seperti tampak pada gambar di atas. Jika seluruh permukaan balok di cat, maka banyaknya kubus yang tidak terkena cat adalah ...", gambar: <SoalImg src={dasarImages[9]} no={9} />, options: ["A. 8 buah", "B. 24 buah", "C. 32 buah", "D. 44 buah"] },
  { no: 10, soal: "Perhatikan gambar berikut!\nSebuah balok yang disusun dari kubus satuan. Jika bagian luar seluruh permukaan balok di cat, maka banyak kubus satuan yang terkena cat pada satu permukaan adalah ....", gambar: <SoalImg src={dasarImages[10]} no={10} />, options: ["A. 26 buah", "B. 42 buah", "C. 52 buah", "D. 102 buah"] },
  { no: 11, soal: "Gambar berikut adalah mainan anak-anak yang berbentuk balok, tersusun dari kubus-kubus satuan yang kongruen. Jika seluruh permukaan balok tersebut dicat, banyaknya kubus satuan yang terkena cat pada dua sisinya saja adalah ....", gambar: <SoalImg src={dasarImages[11]} no={11} />, options: ["A. 16", "B. 18", "C. 24", "D. 28"] },
  ...
  { no: 17, soal: "Apri mendapat tugas untuk membuat kerangka lampu hias yang berbentuk kerangka limas seperti pada gambar. Jika kerangka limas tersebut dibuat dari rotan dan harga 1 m rotan adalah Rp20.000,00, maka biaya yang dibutuhkan seluruhnya adalah ...", gambar: <SoalImg src={dasarImages[17]} no={17} />, options: ["A. Rp64.000,00", "B. Rp52.000,00", "C. Rp44.000,00", "D. Rp22.000,00"] },
  ...
  { no: 25, soal: "Perhatikan gambar kubus ABCD. EFGH berikut.\nJika panjang AB = 24 cm, BC = 10 cm dan 20 cm. Maka luas bidang diagonal ACEG adalah ....", gambar: <SoalImg src={dasarImages[25]} no={25} />, options: ["A. 240 $cm^2$", "B. 480 $cm^2$", "C. 500 $cm^2$", "D. 520 $cm^2$"] },
  { no: 26, soal: "Perhatikan gambar balok ABCD.EFGH berikut!\nJika panjang AB = 15 cm, BC = 8 cm, dan CG = 12 cm, maka luas bidang diagonal ACGE adalah ....", gambar: <SoalImg src={dasarImages[26]} no={26} />, options: ["A. 180 $cm^2$", "B. 136 $cm^2$", "C. 126 $cm^2$", "D. 120 $cm^2$"] },
  ...
  { no: 30, soal: "Perhatikan gambar berikut.\nLuas seluruh bangun tersebut adalah ....", gambar: <SoalImg src={dasarImages[30]} no={30} />, options: ["A. 760 $cm^2$", "B. 720 $cm^2$", "C. 660 $cm^2$", "D. 640 $cm^2$"] },
  ...
  { no: 36, soal: "Perhatikan gambar prisma berikut!\nVolumenya adalah ....", gambar: <SoalImg src={dasarImages[36]} no={36} />, options: ["A. 800 $cm^3$", "B. 1.600 $cm^3$", "C. 2.400 $cm^3$", "D. 3.200 $cm^3$"] },
  ...
  { no: 39, soal: "Perhatikan gambar limas T.ABCD di samping!\nPanjang AB = BC = CD = AD = 30 cm. Jika volume limas 6000 $cm^3$, maka panjang garis TE adalah ....", gambar: <SoalImg src={dasarImages[39]} no={39} />, options: ["A. 20 cm", "B. 25 cm", "C. 35 cm", "D. 40 cm"] },
  ...
  { no: 43, soal: "Perhatikan gambar berikut!\nVolume bangun di atas adalah....", gambar: <SoalImg src={dasarImages[43]} no={43} />, options: ["A. 144 $cm^3$", "B. 576 $cm^3$", "C. 644 $cm^3$", "D. 720 $cm^3$"] },
