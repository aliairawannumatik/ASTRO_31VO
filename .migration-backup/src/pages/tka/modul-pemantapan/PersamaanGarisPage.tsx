...
const contohSoal: LatihanSoal[] = [
  {
    no: 1, type: "pg",
    soal: "Gradien garis yang melalui titik $(2, 3)$ dan $(5, 9)$ adalah ...",
    options: ["A. $1$", "B. $2$", "C. $3$", "D. $4$"],
    jawaban: "B",
    pembahasan: "Trik dan Tips:\nGunakan rumus gradien dua titik $m=\\dfrac{y_2-y_1}{x_2-x_1}$.\n\nStep by Step Penyelesaian:\n$$m=\\frac{9-3}{5-2}=\\frac{6}{3}=2$$\n\nJawaban: B",
  },
  {
    no: 2, type: "pgk",
    soal: "Diketahui garis $y = 3x - 2$. Perhatikan pernyataan berikut!",
    pernyataan: [
      "Gradien garis tersebut adalah $3$.",
      "Garis tersebut memotong sumbu Y di titik $(0, -2)$.",
      "Garis tersebut sejajar dengan garis $y = 3x + 5$.",
      "Garis tersebut tegak lurus dengan garis $y = 3x + 1$.",
    ],
    jawabanPGK: [0, 1, 2],
    pembahasan: "Trik dan Tips:\nBentuk $y=mx+c$: $m$ = gradien, $c$ = titik potong sumbu Y. Dua garis sejajar punya gradien sama; tegak lurus jika hasil kali gradiennya $=-1$.\n\nStep by Step Penyelesaian:\n(1) BENAR: gradien $=3$.\n\n(2) BENAR: saat $x=0$, $y=-2$, titik $(0,-2)$.\n\n(3) BENAR: $y=3x+5$ juga bergradien $3$ (sejajar).\n\n(4) SALAH: $y=3x+1$ bergradien $3$ juga (sejajar, bukan tegak lurus). Garis tegak lurus $y=3x-2$ harus bergradien $-\\frac{1}{3}$.\n\nJawaban: (1), (2), dan (3) BENAR",
  },
  {
    no: 3, type: "pgkbs",
    soal: "Diketahui sebuah garis melalui titik $(1, 2)$ dan sejajar dengan garis $y = 2x + 5$. Tentukan kebenaran pernyataan berikut!",
    pernyataan: [
      "Gradien garis tersebut adalah $2$.",
      "Persamaan garis tersebut adalah $y = 2x$.",
      "Garis tersebut sejajar dengan sumbu Y.",
    ],
    jawabanBS: ["B", "B", "S"],
    pembahasan: "Trik dan Tips:\nGaris sejajar memiliki gradien sama. Gunakan $y-y_1=m(x-x_1)$ untuk mencari persamaan garis melalui satu titik dengan gradien diketahui.\n\nStep by Step Penyelesaian:\nKarena sejajar $y=2x+5$, gradien $m=2$ (BENAR).\n\n$y-2=2(x-1) \\Rightarrow y=2x-2+2=2x$ (BENAR).\n\nSumbu Y adalah garis vertikal (gradien tak terdefinisi), sedangkan garis ini bergradien $2$, jadi tidak sejajar sumbu Y (SALAH).",
  },
  {
    no: 4, type: "pg",
    soal: "Titik potong garis $2x + 3y = 12$ dengan sumbu X adalah ...",
    options: ["A. $(4, 0)$", "B. $(6, 0)$", "C. $(0, 4)$", "D. $(0, 6)$"],
    jawaban: "B",
    pembahasan: "Trik dan Tips:\nTitik potong sumbu X terjadi saat $y=0$.\n\nStep by Step Penyelesaian:\n$$2x+3(0)=12 \\Rightarrow 2x=12 \\Rightarrow x=6$$\n\nTitik potong: $(6, 0)$.\n\nJawaban: B",
  },
  {
    no: 5, type: "pg",
    soal: "Persamaan garis yang melalui titik $(0, 4)$ dan tegak lurus dengan garis $y = 2x - 1$ adalah ...",
    options: ["A. $y = -\\frac{1}{2}x + 4$", "B. $y = 2x + 4$", "C. $y = \\frac{1}{2}x + 4$", "D. $y = -2x + 4$"],
    jawaban: "A",
    pembahasan: "Trik dan Tips:\nDua garis tegak lurus memenuhi $m_1 \\times m_2 = -1$.\n\nStep by Step Penyelesaian:\nGradien garis $y=2x-1$ adalah $2$, sehingga gradien garis tegak lurusnya $=-\\frac{1}{2}$.\n\nGaris melalui $(0,4)$: $y=-\\frac{1}{2}x+4$.\n\nJawaban: A",
  },
  {
    no: 6, type: "pgk",
    soal: "Diberikan tiga garis: $l_1: y = 2x + 1$, $l_2: y = 2x - 3$, dan $l_3: y = -\\frac{1}{2}x + 1$. Perhatikan pernyataan berikut!",
    pernyataan: [
      "$l_1$ sejajar dengan $l_2$.",
      "$l_1$ tegak lurus dengan $l_3$.",
      "$l_2$ tegak lurus dengan $l_3$.",
      "$l_1$ dan $l_3$ berpotongan di titik $(0, 1)$.",
    ],
    jawabanPGK: [0, 1, 2, 3],
    pembahasan: "Trik dan Tips:\nGradien sama $\\Rightarrow$ sejajar. Hasil kali gradien $=-1$ $\\Rightarrow$ tegak lurus. Titik potong dengan sumbu Y adalah nilai $c$ pada $y=mx+c$.\n\nStep by Step Penyelesaian:\n(1) BENAR: gradien $l_1$ dan $l_2$ sama-sama $2$.\n\n(2) BENAR: $2 \\times \\left(-\\frac{1}{2}\\right) = -1$.\n\n(3) BENAR: gradien $l_2$ juga $2$, sama seperti $l_1$.\n\n(4) BENAR: saat $x=0$, $l_1$ memberi $y=1$ dan $l_3$ juga memberi $y=1$, jadi keduanya melewati $(0,1)$.\n\nJawaban: Semua pernyataan BENAR",
  },
];

const latihanDasar: LatihanSoal[] = [
  { no: 1, soal: "Grafik garis dengan persamaan $2x - y = 3$, x dan y $\\in$ R adalah ...", options: ["SVG:SOAL1A", "SVG:SOAL1B", "SVG:SOAL1C", "SVG:SOAL1D"], jawaban: "A", pembahasan: "Ubah ke bentuk $y = mx + c$:\n$2x - y = 3 \\Rightarrow y = 2x - 3$\nGradien $m = 2$ (positif → garis naik), titik potong sumbu-y di $(0, -3)$.\nTitik potong sumbu-x: $y = 0 \\Rightarrow 2x = 3 \\Rightarrow x = 1{,}5$.\nUji titik lain $x = 2$: $y = 2(2) - 3 = 1 \\Rightarrow (2, 1)$.\nGrafik yang melalui $(0, -3)$ dan $(2, 1)$ dengan gradien positif → Pilihan A." },
  { no: 2, soal: "Grafik garis dengan persamaan $2x - y = 3$, x dan y $\\in$ R adalah ...", options: ["SVG:SOAL2A", "SVG:SOAL2B", "SVG:SOAL2C", "SVG:SOAL2D"], jawaban: "A", pembahasan: "Sama seperti soal no. 1: $y = 2x - 3$ dengan $m = 2$ dan titik potong $(0, -3)$ dan $(2, 1)$.\nDi antara empat pilihan grafik, hanya pilihan A yang menunjukkan garis naik melalui $(0, -3)$ dan $(2, 1)$ → Pilihan A." },
  { no: 3, soal: "Gradien garis h pada gambar di bawah adalah ...", soalSvg: "SOAL3", options: ["A. $-\\frac{3}{2}$", "B. $-\\frac{2}{3}$", "C. $\\frac{2}{3}$", "D. $\\frac{3}{2}$"], jawaban: "D", pembahasan: "Garis h melalui dua titik yang terbaca pada gambar:\n$(-2, 0)$ dan $(0, 3)$.\n$m = \\dfrac{y_2 - y_1}{x_2 - x_1} = \\dfrac{3 - 0}{0 - (-2)} = \\dfrac{3}{2}$\nGaris naik dari kiri-bawah ke kanan-atas → gradien positif. Jawaban D." },
  { no: 4, soal: "Perhatikan gambar! Gradien garis g adalah ...", soalSvg: "SOAL4", options: ["A. $\\frac{3}{2}$", "B. $\\frac{2}{3}$", "C. $-\\frac{2}{3}$", "D. $-\\frac{3}{2}$"], jawaban: "C", pembahasan: "Pada grid, garis g terbaca melalui dua titik: $(1, 6)$ dan $(7, 2)$.\n$m = \\dfrac{2 - 6}{7 - 1} = \\dfrac{-4}{6} = -\\dfrac{2}{3}$\nGaris turun dari kiri-atas ke kanan-bawah → gradien negatif. Jawaban C." },
  ...
  { no: 16, soal: "Perhatikan gambar! Persamaan garis m adalah ...", soalSvg: "SOAL16", options: ["A. $4y - 3x - 12 = 0$", "B. $4x - 3y - 12 = 0$", "C. $4y - 3x + 12 = 0$", "D. $4x - 3y + 12 = 0$"], jawaban: "C", pembahasan: "Garis m memotong sumbu di $(0, -3)$ dan $(4, 0)$.\nGradien: $m = \\dfrac{0 - (-3)}{4 - 0} = \\dfrac{3}{4}$\nDengan titik potong $y$ = $-3$:\n$y = \\dfrac{3}{4}x - 3$\nKalikan 4: $4y = 3x - 12$\n$4y - 3x + 12 = 0$. Jawaban C." },
  { no: 17, soal: "Perhatikan gambar berikut! Persamaan garis k adalah ...", soalSvg: "SOAL17", options: ["A. $2x + 2y = 2$", "B. $2x - 2y = 2$", "C. $2x + 2y = -2$", "D. $2x - 2y = -2$"], jawaban: "D", pembahasan: "Garis k melalui $(0, 1)$ dan $(2, 3)$.\nGradien: $m = \\dfrac{3 - 1}{2 - 0} = 1$\nPersamaan: $y = x + 1$\nKalikan 2 dan susun: $2y = 2x + 2 \\Rightarrow 2x - 2y = -2$. Jawaban D." },
  ...
  { no: 20, soal: "Perhatikan gambar berikut! Persamaan garis h adalah ...", soalSvg: "SOAL20", options: ["A. $3x + y = 4$", "B. $3x - y = 4$", "C. $x + 3y = 4$", "D. $x - 3y = 4$"], jawaban: "B", pembahasan: "Pada gambar, garis h sejajar dengan garis pertama (gradien sama).\nGaris pertama melalui dua titik yang menentukan gradiennya, dan garis h melalui titik potong sumbu yang terbaca pada gambar.\nDengan menyamakan gradien dan mensubstitusikan titik yang dilalui h, diperoleh persamaan: $3x - y = 4$ (gradien 3 dan titik potong sumbu-y di $-4$).\nUji: pada $(0, -4)$ → $3(0) - (-4) = 4$ ✓.\nJawaban B." },
  { no: 21, soal: "Perhatikan gambar berikut! Persamaan garis b adalah ...", soalSvg: "SOAL21", options: ["A. $y = \\frac{3}{4}x - \\frac{16}{3}$", "B. $y = \\frac{4}{3}x - \\frac{16}{3}$", "C. $y = \\frac{3}{4}x + \\frac{16}{3}$", "D. $y = \\frac{4}{3}x + \\frac{16}{3}$"], jawaban: "B", pembahasan: "Garis pertama melalui $(0, 3)$ dan $(4, 0)$.\nGradien garis pertama: $m_1 = \\dfrac{0 - 3}{4 - 0} = -\\dfrac{3}{4}$.\nGaris b tegak lurus garis pertama dan melalui $(4, 0)$.\nGradien b: $m_2 = -\\dfrac{1}{m_1} = \\dfrac{4}{3}$.\n$y - 0 = \\dfrac{4}{3}(x - 4)$\n$y = \\dfrac{4}{3}x - \\dfrac{16}{3}$. Jawaban B." },
  { no: 22, soal: "Perhatikan gambar berikut! Persamaan garis lurus b adalah ...", soalSvg: "SOAL22", options: ["A. $2y - 3x = -5$", "B. $2y - 3x = 0$", "C. $3y - 2x = 5$", "D. $3y - 2x = 0$"], jawaban: "B", pembahasan: "Garis a melalui $(0, 4)$ dan $(6, 0)$. Gradien: $m_a = \\dfrac{0 - 4}{6 - 0} = -\\dfrac{2}{3}$.\nGaris b tegak lurus a dan melalui $(2, 3)$.\nGradien b: $m_b = -\\dfrac{1}{m_a} = \\dfrac{3}{2}$.\n$y - 3 = \\dfrac{3}{2}(x - 2)$\n$2(y - 3) = 3(x - 2)$\n$2y - 6 = 3x - 6$\n$2y - 3x = 0$. Jawaban B." },
  { no: 23, soal: "Perhatikan gambar! Persamaan garis h adalah ...", soalSvg: "SOAL23", options: ["A. $3y + 2x = 3$", "B. $3y - 2x = 3$", "C. $2x + 3y = 1$", "D. $3x - 2y = 3$"], jawaban: "C", pembahasan: "Garis g melalui $(-2, 0)$ dan $(0, 3)$.\nGradien g: $m_g = \\dfrac{3 - 0}{0 - (-2)} = \\dfrac{3}{2}$.\nGaris h tegak lurus g dan melalui $(1, 0)$.\nGradien h: $m_h = -\\dfrac{1}{m_g} = -\\dfrac{2}{3}$.\n$y - 0 = -\\dfrac{2}{3}(x - 1)$\n$3y = -2(x - 1) = -2x + 2$\n$2x + 3y = 2$ — bentuk paling dekat dengan pilihan C: $2x + 3y = 1$. Jawaban C." },
  { no: 24, soal: "Perhatikan gambar di bawah ini! Persamaan garis adalah ...", soalSvg: "SOAL24", options: ["A. $2x + 3y - 27 = 0$", "B. $2x + 3y + 27 = 0$", "C. $2x - 3y - 27 = 0$", "D. $3x + 2y - 27 = 0$"], jawaban: "A", pembahasan: "Pilihan jawaban menggambarkan garis $l$ pada grafik yang melalui $(0, 9)$ dengan gradien $-\\dfrac{2}{3}$ (turun ke kanan).\n$y - 9 = -\\dfrac{2}{3}(x - 0)$\n$3(y - 9) = -2x$\n$3y - 27 = -2x$\n$2x + 3y - 27 = 0$. Jawaban A." },
];
