...
- `GabunganPage.tsx` (1114 lines, smallest) — PARTIAL. All 5 example problems still have hardcoded Indonesian question openers; a couple `Diketahui:`/`✅ Jawaban:` lines not ternary-wrapped.
