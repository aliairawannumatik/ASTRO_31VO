...
export const contextualIllustrations: Record<number, (p: IconProps) => ReactElement> = {
  ...
  4: ProduksiIllustration,
  5: TabunganIllustration,
  6: LaptopIllustration,
  7: BbmIllustration,
  8: PopulasiIllustration,
  9: TiketIllustration,
  10: DebitAirIllustration,
  11: DuaTarifIllustration,
  12: GajiIllustration,
  13: JagungIllustration,
  14: TeleponIllustration,
  15: TokoBuahIllustration,
};
