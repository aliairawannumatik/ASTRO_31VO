...
const kelasOptions = [
  { label: "KELAS 7", path: "/lkpd/kelas-7", desc: "LKPD matematika kelas 7 SMP" },
  { label: "KELAS 8", path: "/lkpd/kelas-8", desc: "LKPD matematika kelas 8 SMP" },
  { label: "KELAS 9", path: "/lkpd/kelas-9", desc: "LKPD matematika kelas 9 SMP" },
];
    ...
    <div className="relative min-h-screen flex flex-col items-center gradient-space overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl w-full px-4 py-10">
        ...
        <p className="text-white/60 text-sm text-center mb-8 font-body">
          Pilih kelas untuk mengerjakan lembar kerja peserta didik
        </p>
