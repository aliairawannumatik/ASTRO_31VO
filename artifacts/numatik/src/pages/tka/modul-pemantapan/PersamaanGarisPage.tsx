...
const contohSoal: LatihanSoal[] = [
  {
    no: 1,
    type: "pg",
    soal: "Persamaan garis yang melalui titik $(2, 3)$ dan sejajar dengan garis $2x - y + 5 = 0$ adalah ...",
    options: ["A. $2x - y - 1 = 0$", "B. $2x - y + 1 = 0$", "C. $x - 2y + 4 = 0$", "D. $2x + y - 7 = 0$"],
    jawaban: "A",
    pembahasan:
      "1. JAWABAN\nA. $2x - y - 1 = 0$\n\n2. TRIK & TIPS\nDua garis sejajar memiliki gradien (m) yang sama. Ubah dulu persamaan garis yang diketahui ke bentuk $y = mx + c$ untuk membaca gradiennya, lalu gunakan rumus garis melalui satu titik: $y - y_1 = m(x - x_1)$.\n\n3. STEP BY STEP PENYELESAIAN\nUbah $2x - y + 5 = 0$ ke bentuk $y = mx + c$: $y = 2x + 5$, sehingga $m = 2$.\nKarena sejajar, garis baru juga memiliki gradien $m = 2$.\nGunakan rumus garis melalui titik $(2, 3)$: $y - 3 = 2(x - 2)$\n$y - 3 = 2x - 4$\n$y = 2x - 1$\nUbah ke bentuk umum: $2x - y - 1 = 0$",
  },
  {
    no: 2,
    type: "pg",
    soal: "Gradien garis yang tegak lurus dengan garis $3x + 4y - 12 = 0$ adalah ...",
    options: ["A. $-\\frac{4}{3}$", "B. $-\\frac{3}{4}$", "C. $\\frac{3}{4}$", "D. $\\frac{4}{3}$"],
    jawaban: "D",
    pembahasan:
      "1. JAWABAN\nD. $\\frac{4}{3}$\n\n2. TRIK & TIPS\nDua garis tegak lurus memiliki hasil kali gradien $= -1$, atau $m_2 = -\\dfrac{1}{m_1}$ (kebalikan dan berlawanan tanda). Jangan tertukar dengan syarat sejajar ($m_1 = m_2$).\n\n3. STEP BY STEP PENYELESAIAN\nUbah $3x + 4y - 12 = 0$ ke bentuk $y = mx + c$: $4y = -3x + 12 \\Rightarrow y = -\\dfrac{3}{4}x + 3$.\nGradien garis tersebut adalah $m_1 = -\\dfrac{3}{4}$.\nSyarat tegak lurus: $m_1 \\times m_2 = -1$, sehingga $m_2 = -\\dfrac{1}{m_1} = -\\dfrac{1}{-3/4} = \\dfrac{4}{3}$.\nJadi gradien garis yang tegak lurus adalah $\\dfrac{4}{3}$.",
  },
  {
    no: 3,
    type: "pgk",
    soal: "Diketahui garis $g: 3x - 2y + 6 = 0$.",
    pernyataan: [
      "Gradien garis $g$ adalah $\\dfrac{3}{2}$.",
      "Garis $g$ memotong sumbu-x di titik $(-2, 0)$.",
      "Garis $g$ tegak lurus dengan garis $y = \\dfrac{3}{2}x - 5$.",
      "Garis $g$ melalui titik $(4, 9)$.",
    ],
    jawabanPGK: [0, 1, 3],
    pembahasan:
      "1. JAWABAN\nPernyataan (1), (2), dan (4) BENAR; pernyataan (3) SALAH.\n\n2. TRIK & TIPS\nUbah persamaan garis ke bentuk $y=mx+c$ di awal supaya gradien dan titik potong sumbu langsung terlihat, lalu cek tiap pernyataan satu per satu secara independen.\n\n3. STEP BY STEP PENYELESAIAN\nUbah $3x - 2y + 6 = 0$: $-2y = -3x - 6 \\Rightarrow y = \\dfrac{3}{2}x + 3$. Gradien $m = \\dfrac{3}{2}$, titik potong sumbu-y $(0,3)$.\n(1) Gradien $=\\dfrac{3}{2}$, sesuai. BENAR\n(2) $y=0 \\Rightarrow 3x+6=0 \\Rightarrow x=-2$, titik $(-2,0)$. BENAR\n(3) Garis pembanding $y=\\dfrac{3}{2}x-5$ punya gradien $\\dfrac{3}{2}$, SAMA dengan $m_g$, berarti SEJAJAR bukan tegak lurus. SALAH\n(4) Substitusi $(4,9)$: $3(4)-2(9)+6=12-18+6=0$, memenuhi persamaan. BENAR",
  },
  {
    no: 4,
    type: "pgk",
    soal: "Diketahui dua garis $g_1: y = 2x - 5$ dan $g_2: 4x - 2y + 8 = 0$.",
    pernyataan: [
      "Garis $g_1$ sejajar dengan garis $g_2$.",
      "Garis $g_1$ dan $g_2$ berpotongan di tepat satu titik.",
      "Titik $(0, -5)$ terletak pada garis $g_1$.",
      "Gradien garis $g_2$ adalah $-2$.",
    ],
    jawabanPGK: [0, 2],
    pembahasan:
      "1. JAWABAN\nPernyataan (1) dan (3) BENAR; pernyataan (2) dan (4) SALAH.\n\n2. TRIK & TIPS\nSamakan dulu bentuk kedua garis ($y=mx+c$) supaya mudah dibandingkan. Dua garis sejajar (gradien sama, konstanta beda) TIDAK PERNAH berpotongan — ini sering jadi jebakan.\n\n3. STEP BY STEP PENYELESAIAN\n$g_1$: $y=2x-5$, $m_1=2$, konstanta $-5$.\nUbah $g_2$: $4x-2y+8=0 \\Rightarrow y=2x+4$, $m_2=2$.\n(1) $m_1=m_2=2$ dan konstanta beda ($-5 \\neq 4$) → sejajar. BENAR\n(2) Karena sejajar dan bukan garis yang sama, $g_1$ dan $g_2$ tidak pernah berpotongan. SALAH\n(3) Pada $g_1$, saat $x=0$: $y=2(0)-5=-5$, titik $(0,-5)$ memang pada $g_1$. BENAR\n(4) Gradien $g_2=2$, bukan $-2$. SALAH",
  },
  {
    no: 5,
    type: "pgkbs",
    soal: "Diketahui garis $AB$ melalui titik $A(1, 2)$ dan $B(3, 8)$.",
    pernyataan: [
      "Gradien garis $AB$ adalah 3.",
      "Persamaan garis $AB$ adalah $y = 3x + 1$.",
      "Titik $(0, -1)$ terletak pada garis $AB$.",
    ],
    jawabanBS: ["B", "S", "B"],
    pembahasan:
      "1. JAWABAN\n(1) Benar, (2) Salah, (3) Benar\n\n2. TRIK & TIPS\nKalau diketahui dua titik, cari dulu gradiennya dengan $m=\\dfrac{y_2-y_1}{x_2-x_1}$, baru susun persamaan garis dengan salah satu titik. Verifikasi tiap pernyataan dengan substitusi langsung.\n\n3. STEP BY STEP PENYELESAIAN\nGradien: $m=\\dfrac{8-2}{3-1}=\\dfrac{6}{2}=3$.\n(1) Sesuai perhitungan. BENAR\nSusun persamaan pakai $A(1,2)$: $y-2=3(x-1) \\Rightarrow y=3x-1$.\n(2) Hasil yang benar $y=3x-1$, bukan $y=3x+1$. SALAH\n(3) Substitusi $x=0$: $y=3(0)-1=-1$, cocok dengan $(0,-1)$. BENAR",
  },
  {
    no: 6,
    type: "pgkbs",
    soal: "Diketahui garis $h: 2x + 3y - 6 = 0$.",
    pernyataan: [
      "Garis $h$ memiliki gradien $-\\dfrac{2}{3}$.",
      "Garis $h$ memotong sumbu-x di titik $(3, 0)$.",
      "Garis yang tegak lurus dengan $h$ memiliki gradien $-\\dfrac{3}{2}$.",
    ],
    jawabanBS: ["B", "B", "S"],
    pembahasan:
      "1. JAWABAN\n(1) Benar, (2) Benar, (3) Salah\n\n2. TRIK & TIPS\nUbah dulu ke $y=mx+c$ agar gradien & titik potong sumbu terlihat. Untuk gradien tegak lurus, gunakan $m_2=-\\dfrac{1}{m_1}$ — bukan sekadar mengganti tanda.\n\n3. STEP BY STEP PENYELESAIAN\nUbah $2x+3y-6=0$: $3y=-2x+6 \\Rightarrow y=-\\dfrac{2}{3}x+2$.\n(1) Gradien $=-\\dfrac{2}{3}$, sesuai. BENAR\nTitik potong sumbu-x: $y=0 \\Rightarrow 2x+3(0)-6=0 \\Rightarrow x=3$, titik $(3,0)$.\n(2) Sesuai hasil di atas. BENAR\nGradien tegak lurus: $m_2=-\\dfrac{1}{-2/3}=\\dfrac{3}{2}$ (bukan $-\\dfrac{3}{2}$).\n(3) Hasil yang benar $\\dfrac{3}{2}$, bukan $-\\dfrac{3}{2}$. SALAH",
  },
];
